...
## 技术选择
我们选择vLLM,vLLM 之所以出名，是因为一篇论文提出的想法 —— 把 KV cache 当操作系统的虚拟内存来管。选择他的理由：
- 可以直接从https://huggingface.co/使用最新的开源模型，而ollama得提pr等合并，官方给的模型很少，pr合并相当的慢
- 他支持MLX，SGLang不支持
...
## 总结
实际跑下来模型太吃内存了，效果不是很理想，如果想部署本地大模型一定要买大大大的存储，最近也听闻很多公司开始购买苹果的mac高配版来部署本地的大模型，不得不感慨苹果在AI时代的“躺赢”。另外最近也发现了一些自带本地LLM的应用，大部分原因是因为隐私，我想这可能是未来，随着大模型的加强，内存的扩产，也许有一天会每台电脑自带大模型完成相对简单的工作。